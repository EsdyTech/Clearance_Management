...
?>    
    ...
    <h4><b>CLEARANCE FORM FOR <?php echo  $rows['session'].'  SESSION  '. $rows['level'].' LEVEL';?></b></h4>
...
<?php $cnt=$cnt+1;}}}?>
<?php $query = mysqli_query($con,"select * from students where matricno='$_SESSION[alogin]'")or die(mysqli_error());
$rr = mysqli_fetch_array($query);?>
<tr>
                        <td colspan="2"><b>Clearance Status: <?php echo $rr['isCleared'];?></b></td>
                        <td colspan="2"><b>Date Cleared: <?php echo $rr['dateCleared'];?></b></td>
...
$dompdf->stream($rr['surname'].' '.$rr['firstname']." Clearance Form");
?>