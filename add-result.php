...
if(isset($_POST['submit']))
{
    ...
    $marks=array();$cas=array();
$class=$_POST['class'];
$studentid=$_POST['studentid']; 
$session=$_POST['session']; 
$term=$_POST['term']; 
$mark=$_POST['marks']; $ca=$_POST['cas'];
...
for($i=0;$i<count($mark);$i++){
    $mar=$mark[$i];  $caa=$ca[$i];
  $sid=$sid1[$i];
$sql="INSERT INTO  tblresult(StudentId,ClassId,SubjectId,Session,Term,marks,CA) VALUES(:studentid,:class,:sid,:session,:term,:marks,:cas)";
$query = $dbh->prepare($sql);
$query->bindParam(':studentid',$studentid,PDO::PARAM_STR);
$query->bindParam(':class',$class,PDO::PARAM_STR);
$query->bindParam(':sid',$sid,PDO::PARAM_STR);
$query->bindParam(':marks',$mar,PDO::PARAM_STR);
$query->bindParam(':cas',$caa,PDO::PARAM_STR);
...
function validate(){
var marks = document.getElementsByName('marks[]');//here rr[] is the name of the textbox
var cas = document.getElementsByName('cas[]');//here rr[] is the name of the textbox

 
        for (var i = 0; i < marks.length; i++)
        {        
        if (marks[i].value=="" || cas[i].value=="")
        {
...
if (isNaN(marks[i].value) || isNaN(cas[i].value) ){
...
var cas = document.getElementsByName('cas[]');//here rr[] is the name of the textbox
        ...
        if (marks[i].value > 70)
        {
        alert("Score must not be greater than 70");
        ...
        if (cas[i].value > 30)
        {
        alert("Score must not be greater than 30");
...
<?php }} ?>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="date" class="col-sm-2 control-label ">Session: </label>
                                                        <div class="col-sm-10">
                                                    <select name="session" class="form-control stid"  required="required">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-sm-offset-2 col-sm-10">
                                                            <button type="submit" onClick="return validate()" name="submit" id="submit" class="btn btn-primary">Compute Result</button>
                                                        </div>
                                                    </div>
                                                </form>
