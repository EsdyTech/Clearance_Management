<div class="left-sidebar bg-black-300 box-shadow ">
                        <div class="sidebar-content">
                            <div class="user-info closed">
                                ...
                                <small class="info">Online Clearance</small>
                            </div>
                            <!-- /.user-info -->
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li class="nav-header">
                                        <span class="">Administrator Menu</span>
                                    </li>
...
<a href="#"><i class="fa fa-file-text"></i> <span>Requirements</span> <i class="fa fa-angle-right arrow"></i></a>
<ul class="child-nav">
    <li><a href="add-req.php"><i class="fa fa-bars"></i> <span>Add Requirements</span></a></li>
    <li><a href="manage-req.php"><i class="fa fa fa-server"></i> <span>Manage Requirements</span></a></li>
    <li><a href="adminPrintClearance1.php"><i class="fa fa fa-server"></i> <span>Print Requirements</span></a></li>
...
<ul class="child-nav">
    <li><a href="add-deadline.php"><i class="fa fa-bars"></i> <span>Add Deadline</span></a></li>
    <li><a href="manage-deadline.php"><i class="fa fa fa-server"></i> <span>Manage Deadlines</span></a></li>
   
</ul>
</li>
<li class="has-children">

<a href="#"><i class="fa fa-check"></i> <span>Approve/Clear Students</span> <i class="fa fa-angle-right arrow"></i></a>
<ul class="child-nav">
    <li><a href="clearstd.php"><i class="fa fa-bars"></i> <span>Approve/Clear Student</span></a></li>
    <li><a href="manage-clearstd.php"><i class="fa fa fa-server"></i> <span>Manage Cleared Students</span></a></li>
