                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Requirements List Approved/Unapproved</h5>
                                                </div>
                                            </div>
<?php if($msg){?>
...
<div class="panel-title">
<?php $clearedStatus = "Pending Clearance"; if ($row['isCleared'] == "Cleared"){$clearedStatus = "Cleared";}?>
<h2 class="title" align="center">Clearance Status: <?php echo $clearedStatus;?></h2>
