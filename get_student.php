...
if(!empty($_POST["classid1"])) 
{
 ...
 {?>
  ...
  <input type="text"  name="marks[]" value="" onClick="return validation2()" onChange="return validation()" class="form-control" required="" placeholder="Enter marks out of 70(Exam)" autocomplete="off">
  <input type="text"  name="cas[]" value=""  onClick="return validation2()" onChange="return validation()" class="form-control" required="" placeholder="Enter marks out of 30(Test)" autocomplete="off"></p>
...
<p>
<?php
echo "<span style='color:red'> Result Already Computed! .</span>";
