...
if(isset($_POST['submit']))
    ...
    $query = mysqli_query($con,"select * from adminlogin where id='$_SESSION[alogin]' and password = '$password'")or die(mysqli_error());
    $rows = mysqli_fetch_array($query); $count = mysqli_num_rows($query);
    
    if($count > 0){
    
     $resultt = mysqli_query($con,"update adminlogin set password='$newpassword' where id='$_SESSION[alogin]'") or die(mysqli_error());
