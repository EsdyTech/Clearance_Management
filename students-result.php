...
echo htmlentities('Active');
   ...
   echo htmlentities('Blocked'); 
                                                                ...
                                                                ?></td>
<td>
<a href="view-studentresult.php?rollid=<?php echo htmlentities($result->RollId);?>&classid=<?php echo htmlentities($result->id);?>&session=<?php echo htmlentities($result->Session);?>&term=<?php echo htmlentities($result->Term);?>"><i class="fa fa-file" title="Edit Record"></i> </a> 
