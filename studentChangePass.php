...
$query = mysqli_query($con,"select * from students where matricno='$_SESSION[alogin]' and password = '$password'")or die(mysqli_error());
$rows = mysqli_fetch_array($query); $count = mysqli_num_rows($query);

if($count > 0){

 $resultt = mysqli_query($con,"update students set password='$newpassword' where matricno='$_SESSION[alogin]'") or die(mysqli_error());
