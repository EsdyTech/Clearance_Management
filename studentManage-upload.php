...
if(strlen($_SESSION['alogin'])=="")
    ...
    header("Location: index.php"); 
        ...
        $_SESSION['upId'] = $_GET['upId'];
        $querys = mysqli_query($con,"delete from requploads where upId='$_SESSION[upId]' and uploadStatus='Unapproved'") or die(mysqli_error());
        ...
        { 	
            echo $error="Record has been approved and Cannot be deleted!";
        }
    }
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> Requirements</li>
            							<li class="active">Manage Requirements Uploads</li>
            						</ul>
                                </div>
...
<tr>
                            <td><?php echo $snn; ?>
                            <td><?php echo $rows['firstname'].' '.$rows['othername'];?>
                            <td><?php echo $rows['matricno'];?>
                            <td><?php echo $rowss['reqName']?>
                            <td><?php echo $rowss['reqSession']; ?></td>
                            <td><?php echo $rowss['reqLevel']; ?></td>
                            <td><?php echo $rowd['uploadStatus']; ?></td>
                            <td><a class="btn btn-primary" href="studentManage-upload.php?upId=<?php echo htmlentities($rowd['upId']);?>">Delete</a> 
