                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Print Clearance Requirements</h2>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Select the Requirements info</h5>
                                                </div>
                                            </div>
...
<div class="alert alert-success left-icon-alert" role="alert">
 <strong>Well done!</strong><?php echo htmlentities($msg); ?>
    ...
    <div class="alert alert-danger left-icon-alert" role="alert">
                                        ...
                                        <?php } ?>
        <form class="form-horizontal" method="post" action="adminPrintClearance.php" enctype='multipart/form-data'>
...
<div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
        <button type="submit" name="submit" class="btn btn-primary">Print Requirements</button>
    </div>
</div>
</form>
